...
// topbar — brand link back to the catalog, the page's title, the user
// slot. Inside the catalog's player iframe the shell already provides all
// of that, so the chrome skips itself when framed.
