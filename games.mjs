...
export const GAMES = [
  {
    ...
    modes: ["solo"],
    thumb: { width: 420, height: 420, ticks: 30, options: { cols: 21, rows: 21, wrap: true, started: true } },
  ...
  },
  {
    ...
    modes: ["solo"],
    thumb: { width: 640, height: 480, ticks: 240, options: { started: true } },
    genre: "shooter",
    title: "ASTEROIDS",
    year: 1979,
    blurb:
  ...
  },
  {
    ...
    inputs: ["keyboard", "touch"],
    modes: ["solo"],
    thumb: { width: 600, height: 600, ticks: 500, options: { started: true } },
    genre: "shooter",
  ...
  },
  {
    ...
    inputs: ["keyboard", "touch"],
    modes: ["solo"],
    thumb: { width: 640, height: 480, ticks: 180, options: { started: true } },
    genre: "physics",
    title: "LUNAR LANDER",
    year: 1979,
    blurb:
  ...
  },
  {
    ...
    inputs: ["keyboard", "touch"],
    modes: ["solo"],
    thumb: { width: 480, height: 640, ticks: 400, options: { started: true } },
    genre: "racing",
    title: "RACER",
    year: 1976,
    blurb:
  ...
  },
  {
    ...
    inputs: ["mouse", "touch"],
    modes: ["solo"],
    thumb: { width: 640, height: 480, ticks: 900, options: { started: true } },
    genre: "shooter",
  ...
  },
  {
    ...
    inputs: ["keyboard", "touch"],
    modes: ["solo"],
    thumb: { width: 380, height: 480, ticks: 80, options: { started: true } },
    genre: "puzzle",
    title: "TETRIS",
    year: 1985,
    blurb:
  ...
  },
  {
    ...
    inputs: ["mouse", "touch"],
    modes: ["solo"],
    thumb: { width: 480, height: 560, ticks: 300, options: { started: true } },
    genre: "reflex",
    title: "WHAC-A-MOLE",
    year: 1976,
    blurb:
  ...
  },
  {
    ...
    inputs: ["keyboard", "mouse", "touch"],
    modes: ["solo"],
    thumb: { width: 480, height: 360, ticks: 30, options: { started: true } },
    genre: "reflex",
    title: "CAVE COPTER",
    year: 1998,
    blurb:
  ...
  },
  {
    ...
    inputs: ["keyboard", "mouse", "touch"],
    modes: ["solo"],
    thumb: { width: 480, height: 640, ticks: 25, options: { started: true } },
    genre: "reflex",
    title: "FLAPPY",
    year: 2013,
    blurb:
